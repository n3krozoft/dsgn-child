...
?>
	...
	<section id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header <?php echo esc_attr( $tax_desc ); ?> <?php echo esc_attr( $author_bio ); ?>">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_tax( array( 'people' ) ) ) :
							single_term_title();
							
						elseif ( is_tax( array( 'curators' ) ) ) :
							_e( 'Curator: ', 'designer' );
							single_term_title();
			...
			// if ( is_category() || is_post_type_archive( 'jetpack-portfolio' ) || is_tax( array( 'jetpack-portfolio-type', 'jetpack-portfolio-tag' ) ) ) : 
